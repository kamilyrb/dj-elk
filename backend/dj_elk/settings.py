"""
Django settings for dj_elk project.
...
SECRET_KEY = 'j$&51t98d#40cucm63!vx0(uwkd!3-r#q@t5jy5(+liqli^uwf'
...
WSGI_APPLICATION = 'dj_elk.wsgi.application'
